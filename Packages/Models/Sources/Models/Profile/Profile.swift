...
public extension Profile {
    struct Contributions: Decodable, Sendable {
        ...
        public let duplicateSuggestions: [DuplicateSuggestion]
        ...
        public init(from decoder: Decoder) throws {
            ...
            let duplicateSuggestions: [DuplicateSuggestion] = try container.decode([Product.DuplicateSuggestion].self, forKey: .productDuplicateSuggestions).map { .product($0) }
            ...
            self.duplicateSuggestions = duplicateSuggestions.sorted(by: { $0.createdAt > $1.createdAt })
        }
        ...
        public func copyWith(
            ...
            duplicateSuggestions: [DuplicateSuggestion]? = nil
        ) -> Self {
            .init(
                ...
                duplicateSuggestions: duplicateSuggestions ?? self.duplicateSuggestions
            )
        }
    }
}
