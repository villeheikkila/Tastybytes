...
CREATE OR REPLACE FUNCTION public.fnc__update_check_in(p_check_in_id bigint, p_product_id bigint, p_rating numeric DEFAULT NULL::numeric, p_review text DEFAULT NULL::text, p_manufacturer_id bigint DEFAULT NULL::bigint, p_serving_style_id bigint DEFAULT NULL::bigint, p_friend_ids uuid[] DEFAULT NULL::uuid[], p_flavor_ids bigint[] DEFAULT NULL::bigint[], p_location_id uuid DEFAULT NULL::uuid, p_blur_hash text DEFAULT NULL::text, p_check_in_at text DEFAULT NULL::text)
