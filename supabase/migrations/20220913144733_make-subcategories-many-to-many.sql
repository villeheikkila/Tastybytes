alter table "public"."products" drop constraint "products_sub-brand_id_subcategory_id_manufacturer_id_name_d_key";
...
drop index if exists "public"."products_sub-brand_id_subcategory_id_manufacturer_id_name_d_key";
...
alter table "public"."products" drop column "subcategory_id";

alter table "public"."products" add column "category_id" bigint not null;

CREATE UNIQUE INDEX products_subcategories_pkey ON public.products_subcategories USING btree (product_id, subcategory_id);

CREATE UNIQUE INDEX unique_name_description_joins ON public.products USING btree (name, description, category_id, manufacturer_id, "sub-brand_id");

alter table "public"."products_subcategories" add constraint "products_subcategories_pkey" PRIMARY KEY using index "products_subcategories_pkey";
...
alter table "public"."products" add constraint "unique_name_description_joins" UNIQUE using index "unique_name_description_joins";

alter table "public"."products_subcategories" add constraint "products_subcategories_created_by_fkey" FOREIGN KEY (created_by) REFERENCES profiles(id) not valid;

alter table "public"."products_subcategories" validate constraint "products_subcategories_created_by_fkey";

alter table "public"."products_subcategories" add constraint "products_subcategories_product_id_fkey" FOREIGN KEY (product_id) REFERENCES products(id) not valid;

alter table "public"."products_subcategories" validate constraint "products_subcategories_product_id_fkey";

alter table "public"."products_subcategories" add constraint "products_subcategories_subcategory_id_fkey" FOREIGN KEY (subcategory_id) REFERENCES subcategories(id) not valid;
