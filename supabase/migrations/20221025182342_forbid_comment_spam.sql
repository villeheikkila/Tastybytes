...
begin
  ...
  if v_last_message + interval '10 seconds' then
...
CREATE TRIGGER forbid_send_messages_too_often BEFORE INSERT ON public.check_in_comments FOR EACH ROW EXECUTE FUNCTION tg__forbid_send_messages_too_often();
