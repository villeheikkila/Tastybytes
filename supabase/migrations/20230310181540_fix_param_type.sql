drop function if exists "public"."fnc__create_check_in"(p_product_id bigint, p_rating numeric, p_review text, p_manufacturer_id bigint, p_serving_style_id bigint, p_friend_ids uuid[], p_flavor_ids bigint[], p_location_id uuid, p_blur_hash text);

drop function if exists "public"."fnc__update_check_in"(p_check_in_id bigint, p_product_id bigint, p_rating numeric, p_review text, p_manufacturer_id bigint, p_serving_style_id bigint, p_friend_ids uuid[], p_flavor_ids bigint[], p_location_id uuid, p_blur_hash text, p_check_in_at date);
