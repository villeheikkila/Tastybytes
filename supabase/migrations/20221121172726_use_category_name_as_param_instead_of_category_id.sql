drop function if exists "public"."fnc__search_products"(p_search_term text, p_category_id bigint);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.fnc__search_products(p_search_term text, p_category_name text DEFAULT NULL::text)
