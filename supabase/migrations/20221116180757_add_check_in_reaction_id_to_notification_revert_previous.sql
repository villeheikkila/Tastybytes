drop function if exists "public"."fnc__get_check_in_reaction_notification"(p_check_in_reaction_id bigint, p_notification_id bigint);
...
begin
  ...
  return jsonb_build_object('notification', jsonb_build_object('title', v_title, 'body', v_body, 'check_in_reaction_id', p_check_in_reaction_id));
end;
$function$
;
