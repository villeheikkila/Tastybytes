drop function if exists "public"."fnc__create_check_in"(p_product_id bigint, p_rating integer, p_review text, p_manufacturer_id bigint, p_serving_style_id bigint, p_friend_ids uuid[]);
