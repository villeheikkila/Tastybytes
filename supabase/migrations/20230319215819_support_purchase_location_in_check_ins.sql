drop function if exists "public"."fnc__create_check_in"(p_product_id bigint, p_rating numeric, p_review text, p_manufacturer_id bigint, p_serving_style_id bigint, p_friend_ids uuid[], p_flavor_ids bigint[], p_location_id uuid, p_blur_hash text, p_check_in_at timestamp with time zone);

drop function if exists "public"."fnc__update_check_in"(p_check_in_id bigint, p_product_id bigint, p_rating numeric, p_review text, p_manufacturer_id bigint, p_serving_style_id bigint, p_friend_ids uuid[], p_flavor_ids bigint[], p_location_id uuid, p_blur_hash text, p_check_in_at timestamp with time zone);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.fnc__create_check_in(p_product_id bigint, p_rating numeric DEFAULT NULL::integer, p_review text DEFAULT NULL::text, p_manufacturer_id bigint DEFAULT NULL::bigint, p_serving_style_id bigint DEFAULT NULL::bigint, p_friend_ids uuid[] DEFAULT NULL::uuid[], p_flavor_ids bigint[] DEFAULT NULL::bigint[], p_location_id uuid DEFAULT NULL::uuid, p_blur_hash text DEFAULT NULL::text, p_check_in_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_purchase_location_id uuid DEFAULT NULL::uuid)
...
CREATE OR REPLACE FUNCTION public.fnc__update_check_in(p_check_in_id bigint, p_product_id bigint, p_rating numeric DEFAULT NULL::numeric, p_review text DEFAULT NULL::text, p_manufacturer_id bigint DEFAULT NULL::bigint, p_serving_style_id bigint DEFAULT NULL::bigint, p_friend_ids uuid[] DEFAULT NULL::uuid[], p_flavor_ids bigint[] DEFAULT NULL::bigint[], p_location_id uuid DEFAULT NULL::uuid, p_blur_hash text DEFAULT NULL::text, p_check_in_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_purchase_location_id uuid DEFAULT NULL::uuid)
 RETURNS SETOF check_ins
 LANGUAGE plpgsql
AS $function$
DECLARE
