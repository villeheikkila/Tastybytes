...
--
CREATE DOMAIN "public"."domain__long_text" AS "text" CONSTRAINT "long_text_check" CHECK ((("char_length" (VALUE) >= 1) AND ("char_length" (VALUE) <= 1024)));
...
--
CREATE DOMAIN "public"."domain__name" AS "text" CONSTRAINT "name_check" CHECK ((("char_length" (VALUE) >= 2) AND ("char_length" (VALUE) <= 16)));
...
--
CREATE DOMAIN "public"."domain__rating" AS numeric CONSTRAINT "rating_value_check" CHECK (((VALUE >= (0)::numeric) AND (VALUE <= (5)::numeric)));
...
--
CREATE DOMAIN "public"."domain__short_text" AS "text" CONSTRAINT "short_text_check" CHECK ((("char_length" (VALUE) >= 1) AND ("char_length" (VALUE) <= 100)));
...
--
CREATE DOMAIN "public"."rating" AS smallint CONSTRAINT "rating_check" CHECK (((VALUE >= 0) AND (VALUE <= 10)));
...
--
CREATE FUNCTION "public"."fnc__accept_friend_request" ("user_id" "uuid")
  RETURNS "void"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."fnc__create_check_in" ("p_product_id" bigint, "p_rating" numeric DEFAULT NULL::integer, "p_review" "text" DEFAULT NULL::"text", "p_manufacturer_id" bigint DEFAULT NULL::bigint, "p_serving_style_id" bigint DEFAULT NULL::bigint, "p_friend_ids" "uuid"[] DEFAULT NULL::"uuid"[], "p_flavor_ids" bigint[] DEFAULT NULL::bigint[], "p_location_id" "uuid" DEFAULT NULL::"uuid")
...
--
CREATE FUNCTION "public"."fnc__create_company_edit_suggestion" ("p_company_id" bigint, "p_name" "text", "p_logo_url" "text")
  RETURNS SETOF "public"."company_edit_suggestions"
  LANGUAGE "plpgsql"
  AS $$
DECLARE
...
--
CREATE FUNCTION "public"."fnc__create_product" ("p_name" "text", "p_description" "text", "p_category_id" bigint, "p_sub_category_ids" bigint[], "p_brand_id" bigint, "p_sub_brand_id" bigint DEFAULT NULL::bigint)
...
--
CREATE FUNCTION "public"."fnc__create_product_edit_suggestion" ("p_product_id" bigint, "p_name" "text", "p_description" "text", "p_category_id" bigint, "p_sub_category_ids" bigint[], "p_sub_brand_id" bigint DEFAULT NULL::bigint)
  RETURNS SETOF "public"."product_edit_suggestions"
  LANGUAGE "plpgsql"
  AS $$
DECLARE
...
--
CREATE FUNCTION "public"."fnc__current_user_has_permission" ("p_permission_name" "text")
  RETURNS boolean
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."fnc__delete_current_user" ()
  RETURNS "void"
  LANGUAGE "sql"
  SECURITY DEFINER
  AS $$
...
--
CREATE FUNCTION "public"."fnc__export_data" ()
  RETURNS TABLE (
    "id" "uuid",
    "category" "text",
    "subcategory" "text",
...
--
CREATE FUNCTION "public"."fnc__get_activity_feed" ("p_created_after" "date" DEFAULT NULL::"date")
  RETURNS SETOF "public"."check_ins"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."fnc__get_check_in_reaction_notification" ("p_check_in_reaction_id" bigint)
  RETURNS "jsonb"
  LANGUAGE "plpgsql"
  AS $$
declare
...
--
CREATE FUNCTION "public"."fnc__get_check_in_tag_notification" ("p_check_in_tag" bigint)
  RETURNS "jsonb"
  LANGUAGE "plpgsql"
  AS $$
declare
...
--
CREATE FUNCTION "public"."fnc__get_company_summary" ("p_company_id" integer)
  RETURNS TABLE (
    "total_check_ins" bigint,
    "average_rating" numeric,
    "current_user_average_rating" numeric)
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."fnc__get_edge_function_authorization_header" ()
  RETURNS "jsonb"
  LANGUAGE "sql"
  SECURITY DEFINER
  AS $$
...
--
CREATE FUNCTION "public"."fnc__get_edge_function_url" ("p_function_name" "text")
  RETURNS "text"
  LANGUAGE "sql"
  SECURITY DEFINER
  AS $$
...
--
CREATE FUNCTION "public"."fnc__get_friend_request_notification" ("p_friend_id" bigint)
  RETURNS "jsonb"
  LANGUAGE "plpgsql"
  AS $$
declare
...
--
CREATE FUNCTION "public"."fnc__get_preferred_name" ("p_profile_id" "uuid")
  RETURNS "text"
  LANGUAGE "sql"
  AS $$
select case
...
--
CREATE FUNCTION "public"."fnc__get_product_summary" ("p_product_id" integer)
  RETURNS TABLE (
    "total_check_ins" bigint,
    "average_rating" numeric,
    "current_user_average_rating" numeric)
...
--
CREATE FUNCTION "public"."fnc__get_profile_summary" ("p_uid" "uuid")
  RETURNS TABLE (
    "total_check_ins" bigint,
    "unique_check_ins" bigint,
    "average_rating" numeric,
    "unrated" bigint,
    "rating_1" bigint,
    "rating_2" bigint,
...
--
CREATE FUNCTION "public"."fnc__get_push_notification_request" ("p_receiver_id" "uuid", "p_notification" "jsonb")
  RETURNS TABLE (
    "url" "text",
    "headers" "jsonb",
    "body" "jsonb")
...
--
CREATE FUNCTION "public"."fnc__has_permission" ("p_uid" "uuid", "p_permission_name" "text")
  RETURNS boolean
  LANGUAGE "sql"
  STABLE
  SECURITY DEFINER
...
--
CREATE FUNCTION "public"."fnc__merge_products" ("p_product_id" bigint, "p_to_product_id" bigint)
  RETURNS SETOF "public"."products"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."fnc__post_request" ("url" "text", "headers" "jsonb", "body" "jsonb")
  RETURNS bigint
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  AS $$
...
--
CREATE FUNCTION "public"."fnc__refresh_firebase_access_token" ()
  RETURNS "void"
  LANGUAGE "plpgsql"
  AS $$
declare
...
--
CREATE FUNCTION "public"."fnc__search_products" ("p_search_term" "text")
  RETURNS SETOF "public"."products"
  LANGUAGE "sql"
  AS $$
select p.*
...
--
CREATE FUNCTION "public"."fnc__search_profiles" ("p_search_term" "text")
...
--
CREATE FUNCTION "public"."fnc__update_check_in" ("p_check_in_id" bigint, "p_product_id" bigint, "p_rating" integer DEFAULT NULL::integer, "p_review" "text" DEFAULT NULL::"text", "p_manufacturer_id" bigint DEFAULT NULL::bigint, "p_serving_style_id" bigint DEFAULT NULL::bigint, "p_friend_ids" "uuid"[] DEFAULT NULL::"uuid"[], "p_flavor_ids" bigint[] DEFAULT NULL::bigint[], "p_location_id" "uuid" DEFAULT NULL::"uuid")
  RETURNS SETOF "public"."check_ins"
  LANGUAGE "plpgsql"
  AS $$
DECLARE
...
--
CREATE FUNCTION "public"."fnc__upsert_push_notification_token" ("p_push_notification_token" "text")
  RETURNS "void"
  LANGUAGE "sql"
  SECURITY DEFINER
  AS $$
...
--
CREATE FUNCTION "public"."tg__check_friend_status_transition" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."tg__check_subcategory_constraint" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  AS $$
declare
...
--
CREATE FUNCTION "public"."tg__clean_up_check_in" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
...
--
CREATE FUNCTION "public"."tg__create_default_sub_brand" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__create_friend_request" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__create_profile_for_new_user" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__create_profile_settings" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__forbid_changing_check_in_id" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__forbid_send_messages_too_often" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__friend_request_check" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__is_verified_check" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__make_id_immutable" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__must_be_friends" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__refresh_updated_at" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."tg__remove_unused_tokens" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."tg__send_check_in_reaction_notification" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__send_friend_request_notification" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__send_push_notification" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__send_tagged_in_check_in_notification" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__set_avatar_on_upload" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SECURITY DEFINER
  SET "search_path" TO 'public'
...
--
CREATE FUNCTION "public"."tg__set_check_in_image_on_upload" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__stamp_created_at" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__stamp_created_by" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__stamp_updated_at" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  AS $$
begin
...
--
CREATE FUNCTION "public"."tg__trim_description_empty_check" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
--
CREATE FUNCTION "public"."tg__trim_name_empty_check" ()
  RETURNS "trigger"
  LANGUAGE "plpgsql"
  SET "search_path" TO 'public'
  AS $$
...
ALTER TABLE "public"."brands"
  ...
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."brands_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."check_in_comments"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."check_in_comments_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."check_in_reactions"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."check_in_reactions_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."check_ins"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."check_ins_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."companies"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."companies_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."flavors"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."flavors_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1);
...
ALTER TABLE "public"."friends"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."friends_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1);
...
ALTER TABLE "public"."products"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."products_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
--
ALTER TABLE "public"."products_subcategories"
  ALTER COLUMN "product_id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."products_subcategories_product_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."roles"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."roles_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1);
...
--
ALTER TABLE "public"."serving_styles"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."serving_styles_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE "public"."sub_brands"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."sub_brands_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1);
...
ALTER TABLE "public"."subcategories"
  ALTER COLUMN "id"
  ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
    "public"."subcategories_id_seq" START WITH 1 INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
    CACHE 1);
...
ALTER TABLE ONLY "public"."brand_edit_suggestions"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."brand_edit_suggestions_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."company_edit_suggestions"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."company_edit_suggestions_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."product_edit_suggestion_subcategories"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."product_edit_suggestion_subcategories_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."product_edit_suggestions"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."product_edit_suggestions_id_seq"'::"regclass");

--
-- Name: product_variants id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE ONLY "public"."product_variants"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."product_variants_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."sub_brand_edit_suggestion"
  ALTER COLUMN "id" SET DEFAULT "nextval" ('"public"."sub_brand_edit_suggestion_id_seq"'::"regclass");
...
--
CREATE TRIGGER "add_options_for_profile"
  AFTER INSERT ON "public"."profiles"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__create_profile_settings" ();
...
--
CREATE TRIGGER "check_subcategory_constraint"
  BEFORE INSERT OR UPDATE ON "public"."products_subcategories"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__check_subcategory_constraint" ();
...
CREATE TRIGGER "clean_up"
  ...
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__clean_up_check_in" ();

--
-- Name: brands create_default_sub_brand; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "create_default_sub_brand"
  AFTER INSERT ON "public"."brands"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__create_default_sub_brand" ();

--
-- Name: profile_push_notification_tokens delete_unused_tokens; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "delete_unused_tokens"
  AFTER INSERT ON "public"."profile_push_notification_tokens"
  FOR EACH STATEMENT
  EXECUTE FUNCTION "public"."tg__remove_unused_tokens" ();

--
-- Name: check_in_comments forbid_send_messages_too_often; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "forbid_send_messages_too_often"
  BEFORE INSERT ON "public"."check_in_comments"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__forbid_send_messages_too_often" ();
...
--
CREATE TRIGGER "make_check_in_id_immutable"
  BEFORE UPDATE ON "public"."check_in_comments"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__forbid_changing_check_in_id" ();

--
-- Name: check_in_comments make_id_immutable; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "make_id_immutable"
  BEFORE UPDATE ON "public"."check_in_comments"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__make_id_immutable" ();
...
--
CREATE TRIGGER "make_id_immutable"
  BEFORE UPDATE ON "public"."sub_brands"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__make_id_immutable" ();
...
CREATE TRIGGER "on_friend_request_update"
  BEFORE INSERT OR UPDATE ON "public"."friends"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__check_friend_status_transition" ();

--
-- Name: check_in_tagged_profiles send_notification_on_being_tagged_on_check_in; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "send_notification_on_being_tagged_on_check_in"
  AFTER INSERT ON "public"."check_in_tagged_profiles"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__send_tagged_in_check_in_notification" ();
...
CREATE TRIGGER "send_notification_on_insert"
  ...
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__send_check_in_reaction_notification" ();
...
CREATE TRIGGER "send_notification_on_insert"
  ...
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__send_friend_request_notification" ();
...
CREATE TRIGGER "send_push_notification"
  ...
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__send_push_notification" ();

--
-- Name: friends stamp_created_at; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "stamp_created_at"
  BEFORE INSERT OR UPDATE ON "public"."friends"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__stamp_created_at" ();
...
--
CREATE TRIGGER "stamp_created_by"
  BEFORE INSERT OR UPDATE ON "public"."profile_push_notification_tokens"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__stamp_created_by" ();
...
CREATE TRIGGER "stamp_updated_at"
  BEFORE INSERT OR UPDATE ON "public"."profile_push_notification_tokens"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__stamp_updated_at" ();

--
-- Name: products trim_description_empty_check; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "trim_description_empty_check"
  BEFORE INSERT OR UPDATE ON "public"."products"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__trim_description_empty_check" ();

--
-- Name: brands trim_name_empty_check; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "trim_name_empty_check"
  BEFORE INSERT OR UPDATE ON "public"."brands"
  FOR EACH ROW
  EXECUTE FUNCTION "public"."tg__trim_name_empty_check" ();
...
--
CREATE POLICY "Allow deleting for users with permission" ON "public"."brand_edit_suggestions"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_suggestions'::"text"));

--
-- Name: company_edit_suggestions Allow deleting for users with permission; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Allow deleting for users with permission" ON "public"."company_edit_suggestions"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_suggestions'::"text"));
...
--
CREATE POLICY "Allow deleting for users with permission" ON "public"."product_edit_suggestion_subcategories"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_suggestions'::"text"));
...
--
CREATE POLICY "Allow deleting for users with permission" ON "public"."product_edit_suggestions"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_suggestions'::"text"));
...
--
CREATE POLICY "Allow deleting for users with permission" ON "public"."sub_brand_edit_suggestion"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_suggestions'::"text"));
...
--
CREATE POLICY "Check in comments are viewable by everyone." ON "public"."check_in_comments"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Check in reactions are viewable by everyone." ON "public"."check_in_reactions"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable delete for both sides of friend status" ON "public"."friends"
  FOR DELETE TO "authenticated"
    USING (((("user_id_1" = "auth"."uid" ()) OR ("user_id_2" = "auth"."uid" ())) AND (("status" <> 'blocked'::"public"."enum__friend_status") OR ("blocked_by" = "auth"."uid" ()))));

--
-- Name: brand_edit_suggestions Enable delete for creator; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for creator" ON "public"."brand_edit_suggestions"
  FOR DELETE TO "authenticated"
...
--
CREATE POLICY "Enable delete for creator" ON "public"."check_in_comments"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for creator" ON "public"."company_edit_suggestions"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for creator" ON "public"."product_edit_suggestion_subcategories"
  FOR DELETE TO "authenticated"
    USING ((EXISTS (
      SELECT
        1
...
--
CREATE POLICY "Enable delete for creator" ON "public"."product_edit_suggestions"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for creator" ON "public"."sub_brand_edit_suggestion"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for creator of the check in" ON "public"."check_in_tagged_profiles"
  FOR DELETE TO "authenticated"
    USING ((EXISTS (
      SELECT
        1
...
--
CREATE POLICY "Enable delete for owner" ON "public"."profile_push_notification_tokens"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for the creator" ON "public"."check_in_reactions"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for the creator" ON "public"."check_ins"
  FOR DELETE TO "authenticated"
    USING (("auth"."uid" () = "created_by"));
...
--
CREATE POLICY "Enable delete for the creator of the check in" ON "public"."check_in_flavors"
  FOR DELETE TO "authenticated"
    USING ((EXISTS (
      SELECT
        1
...
--
CREATE POLICY "Enable delete for the owner" ON "public"."notifications"
  FOR DELETE TO "authenticated"
...
--
CREATE POLICY "Enable delete for users with permission" ON "public"."brands"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_brands'::"text"));

--
-- Name: companies Enable delete for users with permission; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for users with permission" ON "public"."companies"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_companies'::"text"));

--
-- Name: product_variants Enable delete for users with permission; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for users with permission" ON "public"."product_variants"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_products'::"text"));

--
-- Name: products Enable delete for users with permission; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for users with permission" ON "public"."products"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_products'::"text"));
...
--
CREATE POLICY "Enable delete for users with permission" ON "public"."products_subcategories"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_products'::"text"));
...
--
CREATE POLICY "Enable delete for users with permission" ON "public"."sub_brands"
  FOR DELETE TO "authenticated"
    USING ("public"."fnc__has_permission" ("auth"."uid" (), 'can_delete_brands'::"text"));
...
--
CREATE POLICY "Enable insert for authenticated users" ON "public"."products_subcategories"
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."brand_edit_suggestions"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."check_in_comments"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."check_in_reactions"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."company_edit_suggestions"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."product_edit_suggestion_subcategories"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."product_edit_suggestions"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."profile_push_notification_tokens"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."sub_brand_edit_suggestion"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."sub_brands"
  FOR INSERT TO "authenticated"
    WITH CHECK (TRUE);
...
--
CREATE POLICY "Enable insert for creator of  the check in" ON "public"."check_in_tagged_profiles"
  FOR INSERT TO "authenticated"
    WITH CHECK ((EXISTS (
      SELECT
        1
...
--
CREATE POLICY "Enable insert for creator of the check in" ON "public"."check_in_flavors"
  FOR INSERT TO "authenticated"
    WITH CHECK ((EXISTS (
      SELECT
        1
...
--
CREATE POLICY "Enable read access for all users" ON "public"."brand_edit_suggestions"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."category_serving_styles"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."check_in_flavors"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."check_in_tagged_profiles"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."company_edit_suggestions"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."flavors"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."product_edit_suggestion_subcategories"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."product_edit_suggestions"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."products_subcategories"
...
--
CREATE POLICY "Enable read access for all users" ON "public"."serving_styles"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for all users" ON "public"."sub_brand_edit_suggestion"
  FOR SELECT
    USING (TRUE);
...
--
CREATE POLICY "Enable read access for intended user" ON "public"."notifications"
  FOR SELECT TO "authenticated"
...
--
CREATE POLICY "Enable read access for owner" ON "public"."profile_push_notification_tokens"
  FOR SELECT TO "authenticated"
...
--
CREATE POLICY "Enable read access only to the owner" ON "public"."profile_settings"
  FOR SELECT TO "authenticated"
    USING (("id" = "auth"."uid" ()));
...
--
CREATE POLICY "Enable select for authenticated users only" ON "public"."profiles_roles"
  FOR SELECT TO "authenticated"
    USING (TRUE);
...
--
CREATE POLICY "Enable select for authenticated users only" ON "public"."roles_permissions"
  FOR SELECT TO "authenticated"
    USING (TRUE);
...
--
CREATE POLICY "Enable update for both sides of friend status " ON "public"."friends"
...
--
CREATE POLICY "Enable update for creator of comment" ON "public"."check_in_comments"
  FOR UPDATE TO "authenticated"
    USING (("auth"."uid" () = "created_by"))
...
--
CREATE POLICY "Enable update for owner" ON "public"."profile_push_notification_tokens"
  FOR UPDATE TO "authenticated"
    USING (("created_by" = "auth"."uid" ()))
    WITH CHECK (("created_by" = "auth"."uid" ()));
...
--
CREATE POLICY "Enable update for the creator" ON "public"."check_ins"
  FOR UPDATE TO "authenticated"
    USING (("created_by" = "auth"."uid" ()));
...
--
CREATE POLICY "Enable update for the owner" ON "public"."profile_settings"
  FOR UPDATE TO "authenticated"
    USING (("id" = "auth"."uid" ()))
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."brands" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."companies" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
    USING (("is_verified" = FALSE));
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."product_variants" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
    USING (("is_verified" = FALSE));
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."products" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
    USING (("is_verified" = FALSE));
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."sub_brands" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
    USING (("is_verified" = FALSE));
...
--
CREATE POLICY "Forbid deleting verified" ON "public"."subcategories" AS RESTRICTIVE
  FOR DELETE TO "authenticated"
    USING (("is_verified" = FALSE));
...
--
CREATE POLICY "Sub-brands are viewable by everyone." ON "public"."sub_brands"
  FOR SELECT
    USING (TRUE);
...
--
GRANT ALL ON SEQUENCE "pgsodium"."key_key_id_seq"
...
--
GRANT ALL ON SEQUENCE "public"."brand_edit_suggestions_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."brands_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."check_in_comments_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."check_in_reactions_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."check_ins_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."companies_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."company_edit_suggestions_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."flavors_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."friends_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."notifications_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."product_edit_suggestion_subcategories_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."product_edit_suggestions_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."product_variants_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."products_subcategories_product_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."roles_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."serving_styles_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."sub_brand_edit_suggestion_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."sub_brands_id_seq"
  TO "anon";
...
--
GRANT ALL ON SEQUENCE "public"."subcategories_id_seq"
  TO "anon";
