...
CREATE OR REPLACE FUNCTION public.fnc__create_check_in(p_product_id bigint, p_rating integer DEFAULT NULL::integer, p_review text DEFAULT NULL::text, p_manufacturer_id bigint DEFAULT NULL::bigint, p_serving_style_id bigint DEFAULT NULL::bigint, p_friend_ids uuid[] DEFAULT NULL::uuid[])
