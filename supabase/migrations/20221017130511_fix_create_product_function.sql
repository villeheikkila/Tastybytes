drop procedure if exists "public"."fnc__create_product"(IN p_name text, IN p_description text, IN p_category_id bigint, IN p_sub_brand_id bigint, IN p_sub_category_ids bigint[]);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.fnc__create_product(p_name text, p_description text, p_category_id bigint, p_sub_brand_id bigint, p_sub_category_ids bigint[])
