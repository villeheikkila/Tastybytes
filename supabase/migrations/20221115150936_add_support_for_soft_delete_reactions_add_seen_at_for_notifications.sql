...
alter table "public"."check_in_reactions" add column "deleted_at" timestamp with time zone;
...
begin
  select id from check_in_reactions where check_in_id = p_check_in_id and created_by = auth.uid();
