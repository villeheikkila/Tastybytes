--! Previous: sha1:a246fa3d248620bdc1713fbeebebe53cced75371
--! Hash: sha1:31a5ffc9bf8169cfe47c2b4ea41ab66f17b99acd
...
with search_agg as (
  ...
  ) select i.*  from search_agg s left join app_public.items i on i.id = s.id where document @@ to_tsquery(search);
$$ language sql stable;
