--! Previous: sha1:a9df49923a664bd1f074df2fa3984d36c84c60e5
--! Hash: sha1:00f569efd1dd14f24bb4393838ffdeb3fd3ba8d0

--! split: 1-current.sql
-- Enter migration here
drop function app_public.add_check_in_comment(target_check_in_id uuid, comment text);

create or replace function app_public.add_check_in_comment(target_check_in_id uuid, comment text) RETURNS app_public.check_in_comments
  LANGUAGE plpgsql
  SECURITY DEFINER
