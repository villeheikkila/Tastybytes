--! Previous: sha1:cf46185fd1304571d740132706d36bcf936ccdf5
--! Hash: sha1:500c1b7f025d023baae0bd2962968c8cbc211053
...
grant
   ...
   insert,
   update
on app_public.company to :DATABASE_VISITOR;

ALTER TABLE app_public.company ENABLE ROW LEVEL SECURITY;

CREATE POLICY restict_update_to_company_creator ON app_public.company FOR UPDATE USING ((created_by = app_public.current_user_id()));
