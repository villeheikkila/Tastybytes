...
class SupabaseConfig {
    ...
    static var url = URL(string: SupabaseConfig.testing ? SupabaseConfig.testingUrlString:  SupabaseConfig.urlString)
    
    static var client = SupabaseClient(
        supabaseURL: SupabaseConfig.url.unsafelyUnwrapped,
        supabaseKey: SupabaseConfig.testing ? SupabaseConfig.testingSupabaseKey : SupabaseConfig.supabaseKey
    )
}
