...
struct SnackContainer: View {
    ...
    var body: some View {
        ...
        ZStack(alignment: .bottom) {
            ...
            layout {
                content(snacks: $snackController.snacks)
            }
            .onTapGesture {
                showOverview.toggle()
            }
    ...
    private func content(snacks: Binding<[Snack]>) -> some View {
        ForEach(snacks) { $snack in
            ...
            snack.view
                ...
                .gesture(
                    DragGesture()
                        .onChanged { value in
                            snack.offsetX = value.translation.width < 0 ? value.translation.width : 0
                        }
                        .onEnded { value in
